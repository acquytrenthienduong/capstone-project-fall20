...
//config upload image in product
...
app.use('/uploads', express.static('uploads')); // for upload img
app.use(cors());
...
app.get(
    "/findAllReservationOfCustomer/:id",
    reservationUserController.findAllReservationOfCustomer
);
//---------------------------------------------------------------------------------//
//manager
